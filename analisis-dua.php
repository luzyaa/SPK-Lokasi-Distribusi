<div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Analisa Topsis 2</li>
        </ol>
      </div> <!-- /.content-header -->
...
<form name="form1" method="post" action="">
  ...
  <tr>
  <td id="ignore" bgcolor="#000000" width="400" colspan="2"><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><font size="2" color="#FFFFFF">BOBOT KEPENTINGAN KRITERIA</font> </font></strong></div></td>
  <?php
